...
<span class="hero-badge-dot"></span>Rust · API-first · Un solo binario
</div>
<h1 class="hero-title">
Ejecuta tus servicios<br>con <em>confianza</em>
</h1>
<p class="hero-desc">Un gestor de procesos ligero: reinicios, orden de arranque, health checks y OTA — define programas en TOML o por REST.</p>
...
<h2 class="hp-heading">Un binario.<br>Cero dependencias.</h2>
<p class="hp-lead" style="margin-top: 0.75rem;">Todo lo necesario para ejecutar, vigilar y recuperar servicios en producción.</p>
...
<p>Scripts en <code>pre_start</code>, <code>post_start</code>, <code>post_stop</code> — preparar entorno, notificar o limpiar.</p>
...
<h3>Event hooks</h3>
<p>Reacciona a <code>process_fatal</code> y eventos del sistema con scripts locales — estilo Supervisor, vía API.</p>
<a href="/docs/03-orchestration/event-hooks" class="feat-card-link">Events →</a>
</div>
<div class="feat-card">
...
<p>Compatible con <code>autorestart</code>, <code>exitcodes</code>, <code>startsecs</code> de Supervisor.</p>
...
<p>Ejecuta programas con expresiones cron. Sin planificador externo ni crontab.</p>
...
<h3>Ops HTTP</h3>
<p>Una API REST para CLI, scripts y control remoto. Auth Bearer vía plugins.</p>
...
<h3>Logs en vivo</h3>
<p>Flujos en tiempo real por WebSocket. Monitorea procesos desde cualquier sitio.</p>
...
<p class="cta-desc">Descarga el binario, define tu stack y ten servicios en minutos.</p>
...
<a href="https://github.com/hzbd/super" class="hp-btn hp-btn--outline" target="_blank" rel="noopener">GitHub</a>
</div>
</div>
</section>
