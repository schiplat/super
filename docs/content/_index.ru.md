---
title: ""
homeTitle: "Super – API-First менеджер процессов на Rust"
description: "Super — открытый API-First менеджер процессов на Rust: декларативная настройка через TOML/REST, проверки состояния, автовосстановление после сбоев, оркестрация зависимостей и журналирование событий с возможностью запросов; расширяется лицензируемыми плагинами (аутентификация, оповещения, лимиты cgroup)."
width: full
toc: false
---
