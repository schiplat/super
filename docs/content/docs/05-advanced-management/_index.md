...
> [!NOTE]
> Pages in this section cover **subscription plugins** (`security`, `isolation`, `notify`). OSS already includes an [embedded Dashboard](/docs/02-essentials/web-ui/) and [core authentication](/docs/02-essentials/authentication/) — those live under **Essentials**. Each page below states which plugin it requires.
...
*   [**Dashboard**](/docs/02-essentials/web-ui/) — embedded shell; Pro UI extensions via the `ui` plugin
